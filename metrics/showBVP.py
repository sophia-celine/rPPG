...
def plot_first_n_samples(folder_path, ref_path=None, n_samples=500, fs=25, ref_fs=62.5, title_prefix="Sinal rPPG"):
    """
...
if __name__ == "__main__":
    ...
    N_SAMPLES = 500  # Quantidade de amostras para visualizar 
    FS = 25          # Frequência de amostragem (FPS da câmera)
    REF_FS = 62.5    # Frequência do sinal de referência (ex: SpO2)

    plot_first_n_samples(TARGET_FOLDER, ref_path=REFERENCE_PATH, n_samples=N_SAMPLES, fs=FS, ref_fs=REF_FS)
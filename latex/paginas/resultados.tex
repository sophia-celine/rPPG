...
\begin{figure}[h!]
    \centering
        ...
        \caption{Correlação média entre os valores de frequência cardíaca obtidos a partir do ECG de referência e estimados pelos métodos de rPPG para o paciente 2}
        Fonte: autoria própria
...
\begin{table*}[h!]
\centering
\caption{Coeficientes de correlação entre os sinais de rPPG e o sinal de PPG de referência para os pacientes 1 e 2.}

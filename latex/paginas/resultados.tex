...
Para o paciente 3, foi realizada a sincronização por meio da geração de um ruído no eletrocardiograma causado pela desconexão e reconexão de um dos eletrodos. Foi possível visualizar o momento de geração desse ruído por um pico na forma de onda do ECG, a qual é apresentada na \autoref{fig:ruido-ecg-L8}. 
